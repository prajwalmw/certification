...
public class RecyclerViewValidationUITest {
     ...
     * ......
     *
     * if click and go to other screen is there than this code is good runs all times...
     * .... recyclerview shouldnt be on homescreen for this than runs all the time.
     * ..... else go with recordEspresso if RecyclerView on Home Screen....
     * **/
